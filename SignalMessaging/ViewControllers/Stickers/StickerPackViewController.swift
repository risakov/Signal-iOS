...
public class StickerPackViewController: OWSViewController {
    ...
    override public func loadView() {
        ...
        defaultPackIconView.setTemplateImageName("check-circle-filled-16", tintColor: .ows_signalOrange)
    ...
    private func updateContent() {
        ...
        authorLabel.textColor = isDefaultStickerPack ? .ows_signalOrange : Theme.darkThemePrimaryColor
