...
- (void)createContents
{
    ...
    [self.sendButton setTemplateImageName:@"send-solid-24" tintColor:UIColor.ows_signalOrangeColor];
    ...
    void (^updateBlock)(void) = ^{
        ...
        if (!hideStickerButton) {
            self.stickerButton.imageView.tintColor
                = (self.desiredKeyboardType == KeyboardType_Sticker ? UIColor.ows_signalOrangeColor
...
- (void)lockVoiceMemoUI
{
    ...
    [sendVoiceMemoButton setTitleColor:UIColor.ows_signalOrangeColor forState:UIControlStateNormal];
